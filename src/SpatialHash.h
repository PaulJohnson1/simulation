...
void tmp_spatial_hash_entity_from_ball(struct tmp_spatial_hash_entity *, struct tmp_ball *);
...
void tmp_spatial_hash_update_multiple(struct tmp_spatial_hash *, uint64_t size, struct tmp_spatial_hash_entity *begin);
