...
static void update_if_transformed(struct tmp_renderer *this)
{
...
void tmp_renderer_init(struct tmp_renderer *this)
{
...
void tmp_renderer_set_dimensions(struct tmp_renderer *this, float w, float h)
{
    this->width = w;
    this->height = h;
    EM_ASM(
...
void tmp_renderer_set_fill(struct tmp_renderer *this, uint32_t c)
{
    float a = this->state.filter.amount;
    uint32_t fc = this->state.filter.color;
    uint8_t red = tmp_fclamp(
        (((c >> 16) & 255) * (1 - a) + ((fc >> 16) & 255) * a), 0, 255);
    uint8_t green =
        tmp_fclamp((((c >> 8) & 255) * (1 - a) + ((fc >> 8) & 255) * a), 0, 255);
    uint8_t blue =
        tmp_fclamp((((c >> 0) & 255) * (1 - a) + ((fc >> 0) & 255) * a), 0, 255);
...
void tmp_renderer_set_stroke(struct tmp_renderer *this, uint32_t c)
{
    float a = this->state.filter.amount;
    uint32_t fc = this->state.filter.color;
    uint8_t red = tmp_fclamp(
...
void tmp_renderer_set_line_width(struct tmp_renderer *this, float w)
{
...
void tmp_renderer_set_text_size(struct tmp_renderer *this, float s)
{
...
void tmp_renderer_set_global_alpha(struct tmp_renderer *this, float a)
{
...
void tmp_renderer_set_line_cap(struct tmp_renderer *this, uint8_t l)
{
...
void tmp_renderer_set_line_join(struct tmp_renderer *this, uint8_t l)
{
...
void tmp_renderer_set_text_align(struct tmp_renderer *this, uint8_t l)
{
...
void tmp_renderer_set_text_baseline(struct tmp_renderer *this, uint8_t l)
{
...
void tmp_renderer_update_transform(struct tmp_renderer *this)
{
    this->matrix_moddified = 1;
}

void tmp_renderer_save(struct tmp_renderer *this)
{
...
void tmp_renderer_restore(struct tmp_renderer *this)
{
    this->matrix_moddified = 1;
...
void tmp_renderer_begin_path(struct tmp_renderer *this)
{
...
void tmp_renderer_move_to(struct tmp_renderer *this, float x, float y)
{
    update_if_transformed(this);
...
void tmp_renderer_line_to(struct tmp_renderer *this, float x, float y)
{
    update_if_transformed(this);
...
void tmp_renderer_quadratic_curve_to(struct tmp_renderer *this, float x1,
...
void tmp_renderer_bezier_curve_to(struct tmp_renderer *this, float x1, float y1,
...
void tmp_renderer_partial_arc(struct tmp_renderer *this, float x, float y,
...
void tmp_renderer_ellipse(struct tmp_renderer *this, float x, float y, float rx,
                         float ry)
{
    update_if_transformed(this);
...
void tmp_renderer_rect(struct tmp_renderer *this, float x, float y, float w,
                      float h)
{
    update_if_transformed(this);
...
void tmp_renderer_draw_clipped_image(struct tmp_renderer *this, struct tmp_renderer *image, float sx, float sy, float sw, float sh, float dx, float dy)
{
    update_if_transformed(this);
...
void tmp_renderer_draw_translated_image(struct tmp_renderer *this,
                                       struct tmp_renderer *image, float x,
                                       float y)
{
    tmp_renderer_draw_clipped_image(this, image, image->width / 2, image->height / 2, image->width, image->height, x, y);
}

void tmp_renderer_draw_image(struct tmp_renderer *this, struct tmp_renderer *image)
{
    tmp_renderer_draw_translated_image(this, image, 0, 0);
}

// note: should only be called at the game instantiation.
void tmp_renderer_draw_svg(struct tmp_renderer *this, char *svg, float x, float y)
{
    update_if_transformed(this);
    EM_ASM(
        {
...
void tmp_renderer_fill_rect(struct tmp_renderer *this, float x, float y, float w,
                           float h)
{
    update_if_transformed(this);
...
void tmp_renderer_stroke_rect(struct tmp_renderer *this, float x, float y,
                             float w, float h)
{
    update_if_transformed(this);
...
void tmp_renderer_fill(struct tmp_renderer *this)
{
    update_if_transformed(this);
...
void tmp_renderer_stroke(struct tmp_renderer *this)
{
    update_if_transformed(this);
...
void tmp_renderer_clip(struct tmp_renderer *this)
{
    update_if_transformed(this);
...
void tmp_renderer_clip2(struct tmp_renderer *this)
{
    update_if_transformed(this);
...
void tmp_renderer_fill_text(struct tmp_renderer *this, char const *c, float x,
                           float y)
{
    update_if_transformed(this);
...
void tmp_renderer_stroke_text(struct tmp_renderer *this, char const *c, float x,
                             float y)
{
    update_if_transformed(this);
...
float tmp_renderer_get_text_size(char const *c)
{
    // clang-format off
...
void tmp_renderer_reset_instruction_queue() { instruction_size = rollovers = 0; }
